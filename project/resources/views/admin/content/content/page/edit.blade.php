...
@endsection
@section('content')
    <h1 style="padding-top: 100px">Sửa Trang {{$page->id .' : '.$page->name}}</h1>
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form class="form-horizontal" name="page" action="{{ url('admin/content/page/'.$page->id) }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Tên Bài Viết</label>
                    <div class="col-sm-8">
                        <input type="text" name="name" class="form-control" id="focusedinput" value="{{$page->name}}" placeholder="Default Input">
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="slug" class="form-control" id="focusedinput" value="{{$page->slug}}" placeholder="Default Input">
                    </div>
                    <div class="col-sm-2">
                        <p class="help-block">Your help text!</p>
                    </div>
                ...
                <span class="input-group-btn">
                     <a id="lfm1" data-input="thumbnail1" data-preview="holder1" class="lfm-btn btn btn-primary">
                       <i class="fa fa-picture-o"></i> Choose
                        ...
                        <input id="thumbnail1" class="form-control" type="text" name="images" value="{{ $page->images }}" placeholder="Default Input">
