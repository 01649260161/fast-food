...
@endsection
@section('content')
    <h1 style="padding-top: 100px">Đơn Hàng Của Bạn</h1>
                    ...
                    @if($order->status == 4)
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <form id="check-order{{$key}}" action="{{url('shipper/shop/order/'.$order->id.'/verify1')}}" method="POST">
                                    @csrf
                                </form>
                                <form id="un-check-order{{$key}}" action="{{url('shipper/shop/order/'.$order->id.'/unverify1')}}" method="POST">
                                    @csrf
                                </form>
                            </td>
                            <td style="text-align: center">
                                ...
                                <form id="check-order-success{{$key}}" action="{{url('shipper/shop/order/'.$order->id.'/success1')}}" method="POST">
                                    @csrf
                                </form>
                            </td>
                            <td style="text-align: center">
                                ...
                                <form id="un-check-order-delete{{$key}}" action="{{url('shipper/shop/order/'.$order->id.'/undelete1')}}" method="POST">
                                    @csrf
                                </form>
                            </td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="check-order-delete{{$key}}" action="{{url('shipper/shop/order/'.$order->id.'/delete1')}}" method="POST">
                                        @csrf
